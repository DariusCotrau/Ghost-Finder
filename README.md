...
Jocul pune la dispoziție o serie de unelte unice pentru investigație.Toate acestea pot fi gasite in afara casei si picked up folosind tasta E. Fiecare item are o mecanică specifică:
...
* **Baterie: ** Lanterna UV poate fi folosită continuu timp de maximum **5 secunde**. Dacă se descarcă complet, sistemul intră în cooldown și are nevoie de **10 secunde** pentru o reîncărcare completă la 100%. Un slider pe UI îți arată în timp real nivelul bateriei.
